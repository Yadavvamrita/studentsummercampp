  ...
  return (
    <div className="landing-container">
      <nav className="landing-nav">
        <div className="nav-logo">🌞 <span className="logo-text">Summer Camp</span></div>
      ...
      <main className="landing-main">
        <img 
          src="/creativity.png" 
          alt="Creativity" 
          className="creative-img-left" 
        />
        <img 
          src="/concept.png" 
          alt="Concept" 
          className="concept-img-right" 
        />
        ...
        {/* Add placeholder sections for scrolling */}
